...
* **Provide Asynchronous Support for Long-Running Requests**.
  ...
  > [!NOTE]
  > For more information about using WebJobs with Azure Website, visit the page [Use WebJobs to run background tasks in Microsoft Azure Websites](app-service-web/web-sites-create-web-jobs.md) on the Microsoft website.
  > 
  > 
...
The [Application Insights - Get started with ASP.NET](application-insights/app-insights-asp-net.md) page on the Microsoft website provides more information.
...
* The [Application Insights - Get started with ASP.NET](application-insights/app-insights-asp-net.md) page on the Microsoft website provides detailed information on installing and configuring Application Insights in an ASP.NET Web API project.
