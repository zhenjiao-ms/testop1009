...
| Name | Meaning |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| `[namespace]` |The Service Bus namespace obtained from the [Azure portal][Azure portal]. | | | | |
| `[username]` |The Service Bus issuer name obtained from the [Azure portal][Azure portal]. | | | | |
| `[password]` |URL-encoded form of the Service Bus issuer key obtained from the [Azure portal][Azure portal]. | | | | |
...
### Message bodies
JMS defines five different message types: **BytesMessage**, **MapMessage**, **ObjectMessage**, **StreamMessage**, and **TextMessage**. The Service Bus .NET API has a single message type, [BrokeredMessage][BrokeredMessage].
...
### Standard headers
The following tables show how the JMS Standard Headers and the [BrokeredMessage][BrokeredMessage] standard properties are mapped using AMQP 1.0.
