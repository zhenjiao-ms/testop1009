...
1. To create a namespace, visit the [Azure classic portal][Azure classic portal]. Click **Service Bus** on the left-hand side, then click **Create**. Type a name for your namespace, accept the defaults for all other values, and then click the OK check mark.
