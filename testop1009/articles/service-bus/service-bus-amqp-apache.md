...
The first step is performed using the [Azure classic portal][Azure classic portal]. The following screen shot shows how a CentOS VM named "scott-centos" is created:
...
In order to log on to the computer, you must know the endpoint port for SSH. You can obtain this value from the [Azure classic portal][Azure classic portal] by selecting the newly created VM and clicking on the **Endpoints** tab. The following screen shot shows that the public SSH port for this computer is 57146.
...
* [Service Bus AMQP overview][Service Bus AMQP overview]
