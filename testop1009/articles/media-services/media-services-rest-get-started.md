---
title: Get started with delivering content on demand using REST | Microsoft Azure
...
1. In the [Azure Classic Portal][Azure Classic Portal], click **New**, click **Media Service**, and then click **Quick Create**.
