...
> [!NOTE]
> If your child jobs return the status "failed", check that your simulated devices are still running on your test system. If not, run the simulate.bat or simulate.sh script again and repeat the reboot device job steps in the preceding section.
> 
> 
