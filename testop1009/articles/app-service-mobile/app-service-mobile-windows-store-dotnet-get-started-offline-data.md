...
8. Uncommment calls to [PushAsync] in the `InsertTodoItem` and `UpdateCheckedTodoItem` methods, then uncomment the call to `SyncAsync` in the `ButtonRefresh_Click` method.
