...
> [!NOTE]
> For more information about FDs and UDs, see [Manage the Availability of Virtual Machines][Manage the Availability of Virtual Machines].
> 
> 

You cannot explicitly allocate a VM to a specific UD and FD; this allocation is controlled by Azure when VMs are created; see the document [Manage the availability of virtual machines][Manage the availability of virtual machines] for more information. However, you can specify that VMs should be created as part of an availability set (AS). VMs in the same AS will be spread across UDs and FDs. If you create VMs manually, Azure will associate each AS with two FDs and five UDs, and machines will be allocated to these FDs and UDs, cycling round as further VMs are provisioned, as follows:
