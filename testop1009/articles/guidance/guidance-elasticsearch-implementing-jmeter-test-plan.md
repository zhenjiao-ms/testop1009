...
You can write a JUnit test by using a Java IDE such as Eclipse. [Deploying a JMeter JUnit Sampler for Testing Elasticsearch Performance][Deploying a JMeter JUnit Sampler for Testing Elasticsearch Performance]
