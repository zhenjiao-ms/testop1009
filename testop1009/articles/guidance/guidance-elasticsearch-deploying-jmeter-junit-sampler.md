...
> [!NOTE]
> If you are using the JMeter Master VM described in [Creating a Performance Testing Environment for Elasticsearch on Azure][Creating a Performance Testing Environment for Elasticsearch on Azure] as your development environment, then download the Windows 32 Bit version of the Eclipse Installer.
> 
> 
