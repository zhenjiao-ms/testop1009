...
> [!NOTE]
> For information about customizing other aspects of the architecture, see [Implementing a secure hybrid network architecture in Azure][implementing-a-secure-hybrid-network-architecture].
> 
> 
